...
final class Instant
{
    ...
    public function __isset(string $name): bool
    {
        return in_array($name, [
            'epochNanoseconds', 'epochMicroseconds',
            'epochMilliseconds', 'epochSeconds',
        ], true);
    }
    ...
    public function round(string|array $options): self
    {
        if (is_string($options)) {
            ...
            $unit = $options['smallestUnit']
                ?? throw new InvalidArgumentException('Missing required option: smallestUnit.');
        ...
        $divisor = match ($unit) {
            ...
            default => throw new InvalidArgumentException(
                "Unknown or unsupported unit for round(): '{$unit}'."
            ),
        };
